    ...
    <section class="footer-bar">
        <div class="container">
          <div class="footer-lang">
            <img class="footer-logo" src={KaaEsh} width={120} alt='s'/>
            <div class="btn-lang-top">
              <a class="lang-btn" href="/"><img src={indiaFlag} alt='s' height="13px" /> India <small><i class="fa fa-chevron-down"></i></small></a>
          ...
          <div class="footer-last-links">
            ...
            <div>
              ...
              <div>
                <img src={appStore1} alt='s' width="137px" />
                <img src={appStore2} alt='s' width="137px" />
              </div>
            </div>
          </div>
