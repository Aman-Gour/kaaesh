    ...
    <section class="team" id="team">
        ...
        <div class="contanier">
            <div class="boxs">
                <div class="box">
                    <div class="img-text">
                        <img class="img-w" src={chef1} alt="s"/>
                        <div class="text">
                            <div class="cont-text">
                                <div class="social">
                ...
                <div class="box">
                    <div class="img-text">
                        <img class="img-w" src={chef2} alt="s"/>
                        <div class="text">
                            <div class="cont-text">
                                <div class="social">
                                <i class="fa-brands fa-facebook-f"><FaFacebook /></i>
                ...
                <div class="box">
                    <div class="img-text">
                        <img class="img-w" src={chef3} alt="s"/>
                        <div class="text">
                            <div class="cont-text">
                                <div class="social">
                                <i class="fa-brands fa-facebook-f"><FaFacebook /></i>
                ...
                <div class="box">
                    <div class="img-text">
                        <img class="img-w" src={chef4} alt="s"/>
                        <div class="text">
                            <div class="cont-text">
                                <div class="social">
                                <i class="fa-brands fa-facebook-f"><FaFacebook /></i>
                ...
                <div class="swiper mySwiper swiper-gst-bk">
                    <div class="swiper-wrapper our-gst">
                        ...
                        <div class="swiper-slide slide">
                            ...
                            <img  class="ribbon" src={ribbon} alt="s"/>
                            ...
                            <img class="img-ourbk" src={blog2} alt="s"/>
                            <p>Lorem, ipsum.</p>
                        </div>
